...
//
DefinitionBlock ("", "SSDT", 2, "THKP", "_ALS0", 0x00001000)
{
    ...
    Scope (_SB)
    {
        // @SEE https://github.com/tianocore/edk2-platforms/blob/master/Platform/Intel/KabylakeOpenBoardPkg/Acpi/BoardAcpiDxe/Dsdt/ALS.ASL
        Device (ALS0)
        {
