...
DefinitionBlock ("", "SSDT", 2, "X1C6 ", "_TB", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.RP09)
    {
        ...
        Name (U2OP, Zero) // Companion controller present?
                ...
                Device (NHI0)
                {
                    ...
                    Method (PCED, 0, Serialized)
                    {
                        ...
                        While (Timer <= Local5)
                        {
                            ...
                            {
                                Debug = "TB:NHI:PCED - Read VID/DID"
                        ...
                        Local0 = Package (0x13)
                            {
                                ...
                                Buffer (0x20)
                                {
                                    ...
                                    /* 0018 */  0x03, 0x03, 0x02, 0x00, 0x03, 0x00, 0x04, 0x00   // ........
                                }, 
